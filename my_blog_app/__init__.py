...
from my_blog_app.core.views import core
from my_blog_app.users.views import users
from my_blog_app.blog_posts.views import blog_posts
from my_blog_app.error_pages.handlers import error_pages
